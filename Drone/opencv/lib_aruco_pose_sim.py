...
def clock_cb(data):
    global current_sim_time_s, current_sim_time_ns 
    current_sim_time_s = data.clock.secs
    current_sim_time_ns = data.clock.nsecs
...
class ArucoSingleTracker():
    ...
    def track(self, loop=True, verbose=False, show_video=None):       
        ...
        x = y = z = 0
        #rate = rospy.Rate(30)
        prev_sim_time = current_sim_time_s + current_sim_time_ns/1000000000  
