...
########################################################################################################
	...
	parser.add_argument('--waypoints', default=((-5,5,180),			#Coordinate for W[1]/W[5] and heading angle while going to W[1]/W[5]
												(-5,-5,180)),			#Coordinate for W[2] and heading angle while going to W[2]
												nargs="+",
												type=list)
